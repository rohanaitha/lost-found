    ...
    <div className="flex items-center justify-center min-h-screen bg-[url('https://i.pinimg.com/736x/63/d2/4d/63d24d40d82e8e0e7ff38b36f4044823.jpg')] bg-cover bg-center">
      ...
      <div className="w-[380px] rounded-2xl bg-white/10 p-8 shadow-2xl backdrop-blur-xl border border-white/20  text-gray-900">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm mb-1 text-white">Report Type</label>
            <select
              value={reportType}
              onChange={(e) => setReportType(e.target.value)}
              className="w-full rounded-lg bg-transparent text-white border-1 border-white/40 p-2 focus:outline-none focus:ring-1 focus:ring-white outline-none"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border-b border-white/40 focus:border-b-2 focus:border-emerald-400 bg-transparent text-white p-2 placeholder-white  outline-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border-b border-white/40 focus:border-b-2 focus:border-emerald-400 bg-transparent text-white p-2 placeholder-white outline-none  resize-none h-20"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border-b border-white/40 focus:border-b-2 focus:border-emerald-400 bg-transparent text-white p-2 outline-none "
            />
          </div>
